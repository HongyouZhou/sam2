...
ANNOTATION_PATH = r"/home/hongyou/dev/data/sam2_val_data/UIIS/UDW/annotations/val.json"
IMAGE_PATH = r"/home/hongyou/dev/data/sam2_val_data/UIIS/UDW/val"

# sam2_checkpoint = "../checkpoints/sam2_hiera_large.pt"
# model_cfg = "sam2_hiera_l.yaml"
# sam2_checkpoint = "../checkpoints/sam2_hiera_base_plus.pt"
model_cfg = "configs/sam2.1/sam2.1_hiera_b+.yaml"
sam2_checkpoint = "/home/hongyou/dev/ada_samp/sam2/checkpoints/sam2.1_hiera_base_plus.pt"
...
if __name__ == '__main__':
    ...
    sam2 = build_sam2(
        ...
        hydra_overrides_extra=[
            "++model.sam_mask_decoder_extra_args.use_bndl_for_pixels=false"
        ],
    )
    ...
    # 在调用 loadRes 前确保 info / licenses 存在
    for key in ("info", "licenses"):
        cocoGT.dataset.setdefault(key, {} if key == "info" else [])
