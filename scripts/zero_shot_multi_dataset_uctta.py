...
def inference_with_uctta(
    ...
    checkpoint_mgr = CheckpointManager(
        ...
        dataset_name=dataset_name if dataset_name else "uctta",
    ...
    for v_idx, vid in enumerate(video_names, 1):
        ...
        for f_idx, out_obj_ids, out_logits in predictor.propagate_in_video(
            ...
            for i, oid in enumerate(out_obj_ids):
                ...
                seg[oid] = threshold_mask_logits(scaled, score_thresh)
    ...
    if dataset_eval is not None and len(dataset_eval) > 0:
        try:
            ...
            uctta_statistics['eval_pavpu_uncertainty_samples'] = unc_down
            uctta_statistics['eval_pavpu_accuracy_samples'] = acc_down
