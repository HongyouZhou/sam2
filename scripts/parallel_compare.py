...
def main():
    ...
    parser.add_argument("--bndl_aue_checkpoint", default="/home/hongyou/dev/ada_samp/logs/sam2/sam2_bndl_aue_015_01/checkpoints/checkpoint.pt")
    ...
    parser.add_argument("--bndl_aue_version", type=str, default="015_01")
